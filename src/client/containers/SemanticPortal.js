...
import Main from '../components/perspectives/emlo/Main'
...
import { rootUrl, layoutConfig } from '../configs/emlo/GeneralConfig'
...
const mapStateToProps = state => {
  ...
  return {
    ...
    actorsFacetsConstrainSelf: state.actorsFacetsConstrainSelf,
